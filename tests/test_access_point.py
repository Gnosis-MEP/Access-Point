...
class TestAccessPoint(MockedEventDrivenServiceStreamTestCase):
    ...
    MOCKED_STREAMS_DICT = {
        SERVICE_STREAM_KEY: [],
        'cg-AccessPoint': MOCKED_CG_STREAM_DICT,
    }

    @patch('access_point.service.AccessPoint.process_event_type')
