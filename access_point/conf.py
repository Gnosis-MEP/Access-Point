...
AP_WEBSOCKET_PORT = config('AP_WEBSOCKET_PORT', default='8000', cast=int)
AP_WEBSOCKET_HOST = config('AP_WEBSOCKET_HOST', default='localhost')
AP_WEBSOCKET_PATH = config('AP_WEBSOCKET_PATH', default='/pub_sub')

AP_WEBSOCKET_ADDRESS = f'ws://{AP_WEBSOCKET_HOST}:{AP_WEBSOCKET_PORT}{AP_WEBSOCKET_PATH}'

AP_WS_EXTERNAL_ADDRESS = config('AP_WS_EXTERNAL_ADDRESS', default=AP_WEBSOCKET_ADDRESS)



SERVICE_STREAM_KEY = config('SERVICE_STREAM_KEY')

QUERY_RECEIVED_STREAM_KEY = config('QUERY_RECIEVED', default='QueryReceived')
PUBLISHER_CREATED_STREAM_KEY = config('PUBLISHER_CREATED', default='PublisherCreated')
